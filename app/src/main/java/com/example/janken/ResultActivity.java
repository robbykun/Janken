...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView myHnadImageView = (ImageView) findViewById(R.id.my_hand_image);

        switch (id) {
            case R.id.gu:
                myHnadImageView.setImageResource(R.drawable.gu);
                myHand = JANKEN_GU;
                break;
            case R.id.choki:
                myHnadImageView.setImageResource(R.drawable.choki);
                myHand = JANKEN_CHOKI;
                break;
            case R.id.pa:
                myHnadImageView.setImageResource(R.drawable.pa);
                myHand = JANKEN_PA;
                break;
        }
    ...
    private void saveDate(int myHand, int comHand, int gameResult) {
        ...
        editor.putInt("LAST_COM_HAND", lastComHand);
